...
cmds.rotate(0, -135, 0, ws=True, r=True)
cmds.move(0, -1.5, 0, r=True)

branches.append(cmds.duplicate(branches[0]) [0] )
cmds.rotate(0, 120, 0, ws=True, r=True)
cmds.move(0, 2.4, 0, r=True)

branches.append(cmds.duplicate(branches[0]) [0] )
cmds.rotate(0, -45, 0, ws=True, r=True)
cmds.move(-0.69, 0, -1.1, r=True)
